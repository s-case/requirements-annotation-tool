...
from auth import login, register, logout, whoami, NotAuthorisedError, change_password
from common import ProtocolError
from config import DATA_DIR
from convert.convert import convert
from docimport import save_import, folder_import, import_xmi
...
from externalannotator import auto_annotate
...
DISPATCHER = {
        ...
        'importXmi': import_xmi,
        'importFolder': folder_import,

        'autoAnnotateDocument': auto_annotate,
